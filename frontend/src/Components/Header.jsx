  ...
  return (
    <>
      <Navbar className="navbar absolute top-0 flex items-center justify-beetween bg-black w-full mx-auto">
        <div  className="navbar-start md:mx-20 my-10"><Link to="/"><img src="/logo.png" alt="M.T. Tasin" className="w-[40px] h-[40px] md:w-[40px] md:h-[40px]" /></Link></div>
        <div className="navbar-end md:mx-20 my-10">
      ...
      <Drawer open={isOpen} onClose={handleClose} className="w-full duration-700 league-spartan ">
        ...
        <div className="h-full w-full grid grid-cols-1 md:grid-cols-2">
            <div className="grid grid-cols-6">
              <div className="col-span-1 flex flex-col justify-start items-end mt-24 md:mt-28"><h2 className="-rotate-90 text-3xl">Menu</h2></div>
            <div className="col-span-5 flex flex-col justify-center items-start md:text-7xl text-6xl font-bold md:m-20">
                <NavLink onClick={handleClose} className="my-5" to="/">Home</NavLink>
                <NavLink onClick={handleClose} className="my-5" to="/projects">Projects</NavLink>
                <NavLink onClick={handleClose} className="my-5" to="/about">About</NavLink>
                <NavLink onClick={handleClose} className="my-5" to="/contact">Contact</NavLink>
            </div>
            </div>
        ...
        <div className="absolute top-5 right-5"><FaX onClick={handleClose} className="text-3xl md:m-14" /></div>
      </Drawer>
    </>
  )
}